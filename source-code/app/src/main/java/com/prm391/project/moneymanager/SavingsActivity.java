    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saving_target.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Cursor c2 = sqLiteDatabase.rawQuery("select s_target from savings " +
                        "where budget_id in (select b_id from budget where b_month=" + month + " and b_year=" + year + ");", null);
                c2.moveToFirst();
        ...
        current_saving.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Cursor c = sqLiteDatabase.rawQuery("select s_target from savings " +
